												...
												if( ( 8 < ZogenSa <= 16) == False ):
													...
													if( -400 <= zensoKyoriSa <= 0):
														...
														if(Kyakushitu == 3):
															...
															if(BabaCD == "4"):
																m += 1																
															if(int(UMA_RACE["Barei"]) == 4):
																m += 1
															if(int(UMA_RACE["Barei"]) == 5):
																m += 1
															if(UMA_RACE["SexCD"] == "2" ):
																m += 1
															if(UMA_RACE["Wakuban"] == "1" ):
																m += 1
															...
															if( (450 <= int(UMA_RACE["BaTaijyu"]) < 460)):
																m += 1
															if( (490 <= int(UMA_RACE["BaTaijyu"]) < 500)):
																m += 1
															...
															if( zensoJyoCD == "09" ):
																m += 1
															if( -400 <= zensoKyoriSa < -200):
																m += 1

															if( zensoOdds_int == 2 or  zensoOdds_int == 6 or zensoOdds_int == 9 or zensoOdds_int == 11 or zensoOdds_int == 13 or zensoOdds_int >= 15):
																m += 1
															if( zensoJyuni == 4 or zensoJyuni == 6 or zensoJyuni == 7 ):
																m += 1
															if( zensoAgariJyuni == 1 or zensoAgariJyuni == 2 or zensoAgariJyuni == 3 or zensoAgariJyuni == 5 or zensoAgariJyuni == 6 or zensoAgariJyuni == 7 or zensoAgariJyuni == 9):
																m += 1
